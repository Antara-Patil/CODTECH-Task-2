...
values ("Microbiology"," Salman Rush",1),
("Thesis", "Arundhati Roy",4),
("Physics","Chitra Banerjee",2),
("Science","Vikram Chandra",6);

insert into Student (Student_Name,Phone_No,Email_ID,Date_Of_Birth)
values('Arnav Mehta','987-654-3210','arjun.mehta@example.com','2003-01-15'),
('Prem Kapoor','876-543-2109','priya.kapoor@example.com','2004-03-22'),
('Rohit Desai','654-321-098','rahul.desai@example.com','2003-06-10');
